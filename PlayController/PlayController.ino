...
//state used to update button LEDs
...
void setup() {
  ...
  testLEDS(65);     //blink every LED once to test (with a delay of 10 ms)
}
...
void loop() {
  ...
  if(debug){
    //Debug mode simply displays the button states on the LCD.
   ...
   clearLCD();
   writeLCD("Prepare for liftoff");
   animate_fuel(10,30,50,70,90);
   delay(100);
  }
}
